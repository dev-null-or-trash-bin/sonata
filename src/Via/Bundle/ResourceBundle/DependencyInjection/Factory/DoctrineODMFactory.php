...
class DoctrineODMFactory extends AbstractFactory
{
    public function create($prefix, $resourceName, array $classes, $templates = null)
    {
        ...
        $repositoryClass = isset($classes['repository']) ? $classes['repository'] : 'Via\Bundle\ResourceBundle\Doctrine\ODM\MongoDB\DocumentRepository';
    ...
    {
        return ViaResourceBundle::DRIVER_DOCTRINE_MONGODB_ODM;
    }
}